 ...
 * @property News[] $news
 * @property Reputation[] $reputations
 * @property Reputation[] $reputations1
...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('username, password, email, password2, verifyCode,', 'required','message'=>'{attribute} Tidak Boleh Kososng'),
	...
	public function relations()
	{
		...
		return array(
			...
			'reputations' => array(self::HAS_MANY, 'Reputation', 'pemberi_id'),
			'reputations1' => array(self::HAS_MANY, 'Reputation', 'penerima_id'),
