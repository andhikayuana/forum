...
<div class="container" id="page">
	...
	<div>
		...
		foreach ($kategori as $i => $ii) {
			$kategoriAll[]=array(
				'label'=>$ii['kategori'],
				'url'=>array('/thread/index','id'=>$ii['id']),
			);
		}
		...
		$this->widget('ext.mbmenu.MbMenu',array(
			'items'=>array(
				...
				array('label'=>'Logout', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest,'linkOptions'=>array('onclick'=>'return confirm("Anda ingin Keluar?")')),
			),
		)); ?>
	</div><!-- mainmenu -->
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by Yuana, Andhika.<br/>
